...
#     translations = request_translation(batch, target_language)
#     translations = [translation.strip().split(': ')[1] if ': ' in translation else '' for translation in translations]
...
#
#         # Заполнение недостающих значений пустыми строками
#         missing_rows = end_idx - start_idx - len(translations)
#         translations += [''] * missing_rows
#
#         data.loc[start_idx:end_idx - 1, cfg['settings']['save_column_A']] = translations[:end_idx - start_idx]
#
#         translated_text_A.extend(translations)
#
#         # Сохранение данных в новый файл Excel после каждого пакета
...
#
# logger.info(f'Translation completed. Result saved to: {new_file_name}')
